...
public:
  ...
  // TCL variable no_inv_power_calc.
  bool noInvPowerCalc() const { return no_inv_power_calc_; }
  void setNoInvPowerCalc(bool enable) { no_inv_power_calc_ = enable; }
...
private:
  ...
  // SILIMATE:
  bool boolean_props_as_int_{true};
  bool direction_props_short_{false};
  bool liberty_line_debug_{false};
  bool no_inv_delay_calc_{false};
