...
public:
  ...
  [[nodiscard]] bool isClock(const Pin *pin) const;
  [[nodiscard]] bool isRiseEdgeTriggered(const Pin *pin) const;
  [[nodiscard]] bool isFallEdgeTriggered(const Pin *pin) const;
